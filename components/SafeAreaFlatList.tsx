...
const SafeAreaFlatList = forwardRef(<ItemT,>(props: SafeAreaFlatListProps<ItemT>, ref: React.ForwardedRef<FlatList<ItemT>>) => {
...
}) as <ItemT>(props: SafeAreaFlatListProps<ItemT> & React.RefAttributes<FlatList<ItemT>>) => React.ReactElement;
