    ...
    return (
      <View style={{ flex: 1 }}>
        ...
        <ScrollView horizontal showsHorizontalScrollIndicator={false} style={{ flexDirection: 'row', paddingHorizontal: 16 }}>
          {/* 1st block */}
          <View
            style={{ width: 140, backgroundColor: '#EEF0F4', borderRadius: 8, padding: 8, justifyContent: 'space-around', marginRight: 16 }}
          >
            <View style={{ flexDirection: 'row' }}>
              <View style={{ width: 32, marginRight: 8 }}>
                <Image
                  ...
                  source={{
                    uri: 'https://hodlhodl-exchange.s3.amazonaws.com/uploads/account/avatar/ea/0b/b1/eb/6e11ff0205ff59977e4cec15.jpg',
                  }}
                />
              </View>
              <View style={{}}>
            ...
            <View style={{ flexDirection: 'row', marginTop: 16 }}>
              <View style={{ backgroundColor: '#fff', borderRadius: 20, paddingVertical: 5, paddingHorizontal: 8 }}>
                <Text style={{ fontSize: 11, alignItems: 'center', color: '#9AA0AA', fontWeight: '600' }}>$7534.34</Text>
              </View>
            </View>
          </View>
            ...
            <View style={{ flexDirection: 'row' }}>
              ...
              <View style={{}}>
                <Text
                  numberOfLines={1}
                  ellipsizeMode="tail"
                  style={{ marginBottom: 2, fontWeight: 'bold', fontSize: 15, color: BlueApp.settings.foregroundColor }}
                >
                  asdfsd
                </Text>
                <Text style={{ fontSize: 9, color: '#9AA0AA' }}>97%</Text>
