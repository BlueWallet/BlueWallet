...
function encrypt(
  ...
  return bs58check.encode(
    encryptRaw(buffer, compressed, passphrase, progressCallback, scryptParams)
  );
}
...
async function decryptECMult(
  ...
  var decipher2 = aes.createDecipheriv(
    "aes-256-ecb",
    derivedHalf2,
    Buffer.alloc(0)
  );
