...
const icons = {
  ...
  SearchAccount: { iconValue: Platform.OS === 'ios' ? 'magnifyingglass' : 'ic_menu_search' },
  Passphrase: { iconValue: Platform.OS === 'ios' ? 'rectangle.and.pencil.and.ellipsis' : 'ic_menu_edit' },
