module.exports = {
  _: {
    storage_is_encrypted:
      "Dein Speicher ist verschlüsselt. Zum Entschlüsseln wird ein Passwort benötigt.",
  ...
  wallets: {
    ...
    scanQrWif: {
      ...
      password_explain:
        "Das ist ein mit BIP38 verschlüsselter geheimer Schlüssel",
  ...
  transactions: {
    list: {
      ...
      title: "Transaktionen",
      description:
        "Eine Liste eingehender oder ausgehender Transaktionen deiner Wallets",
      conf: "conf"
    },
    details: {
      title: "Transaktionen",
  ...
  send: {
    ...
    details: {
      ...
      total_exceeds_balance:
        "Der zu sendende Betrag ist größer als der verfügbare Betrag.",
      create_tx_error:
        "Fehler beim Erstellen der Transaktion. Bitte stelle sicher, dass die Adresse korrekt ist.",
      address: "Adresse",
      amount_placeholder: "Betrag (in BTCV)",
      fee_placeholder: "plus Gebühr (in BTCV)",
    ...
    create: {
      ...
      title: "Transaktion erstellen",
      error:
        "Fehler beim Erstellen der Transaktion. Falsche Adresse oder Betrag?",
      go_back: "Zurück",
      this_is_hex:
  ...
  buyBitcoin: {
    ...
    tap_your_address:
      "Adresse antippen, um sie in die Zwischenablage zu kopieren:",
