module.exports = {
  _: {
    storage_is_encrypted:
      "ที่เก็บข้อมูลของคุณถูกเข้ารหัส. ต้องการรหัสผ่านเพื่อถอดรหัส",
  ...
  wallets: {
    ...
    list: {
      ...
      title: "กระเป๋าสตางค์",
      header:
        "กระเป๋าสตางค์คือที่เก็บไพร์เวทคีย์และแอดเดรส" +
        "ที่คุณสามารถแชร์เพื่อโอนรับเหรียญ.",
  ...
  send: {
    ...
    details: {
      ...
      create_tx_error:
        "ไม่สามารถสร้างธุรกรรมได้.  กรุณาตรวจสอบแอดเดรสให้ถูกต้อง.",
      address: "แอดเดรส",
      amount_placeholder: "จำนวนเงินที่ส่ง (หน่วย BTCV)",
      fee_placeholder: "รวมค่าธรรมเนียม (หน่วย BTCV)",
    ...
    create: {
      ...
      title: "สร้างธุรกรรม",
      error:
        "ไม่สามารถสร้างธุรกรรมได้. แอดเดรสไม่ถูกต้อง หรือ จำนวนเงินไม่ถูกต้อง?",
      go_back: "กลับ",
      this_is_hex:
        "นี่คือ hex ของธุรกรรม, signed แล้วและพร้อมที่จะบรอดคาซท์ไปยังเน็ตเวิร์ค.",
      to: "ถึง",
      amount: "จำนวนเงิน",
      fee: "ค่าธรรมเนียม",
      tx_size: "ขนาดธุรกรรม",
  ...
  plausibledeniability: {
    ...
    help:
      ...
      "และเป็นความลับ.",
    help2:
      "ที่เก็บข้อมูลอันใหม่จะทำงานได้สมบูรณ์ และคุณสามารถเก็บจำนวนเงินขั้นต่ำได้ " +
      "โดยที่มีความน่าเชื่อถือ.",
