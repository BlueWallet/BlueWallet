module.exports = {
  _: {
    storage_is_encrypted:
      "Vaš spremnik je kriptiran. Za dekripcoju je potrebna lozinka.",
  ...
  wallets: {
    ...
    list: {
      ...
      title: "Voleti",
      header:
        "Volet je par privatnog ključa (tajna!) i javne adrese " +
        "koju slobodno možete dijeliti kada primate novce.",
      add: "Dodaj volet",
    ...
    import: {
      ...
      imported: "Uneseno",
      error:
        "Neuspješan unos. Molimo pažljivo provjerite ispravnost unesenih podataka.",
      success: "Uspjeh",
      do_import: "Unesi",
  ...
  send: {
    ...
    details: {
      ...
      create_tx_error:
        "Pogreška prilikom stvaranja transakcije. Molimo provijeri da je adresa ispravna.",
      address: "adresa",
      amount_placeholder: "iznos za slanje (u BTCV)",
      fee_placeholder: "plus trošak transakcije (u BTCV)",
    ...
    create: {
      ...
      go_back: "Nazad",
      this_is_hex:
        "Ovoj je hex transakcije, potpisan i spreman za objavljivanje na mrežu.",
      to: "Za",
      amount: "Iznos",
      fee: "Trošak slanja",
      tx_size: "TX veličina",
  ...
  plausibledeniability: {
    ...
    create_password_explanation:
      "Lozinka za fejk spremnik treba biti drugačija od lozinke za oriđi spremnik",
  ...
  lnd: {
    ...
    sameWalletAsInvoiceError:
      "Buraz! Ne možeš platiti račun s istim voletom s kojim si račun stvorio, ono."
  },
  pleasebackup: {
