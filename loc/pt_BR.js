module.exports = {
  _: {
    storage_is_encrypted:
      "Os arquivos estão criptografados, uma senha é necessária",
  ...
  wallets: {
    ...
    createBitcoinWallet:
      "Antes de criar a carteira Lightning é preciso criar uma carteira Bitcoin, tudo bem?",
  ...
  transactions: {
    list: {
      ...
      title: "Transações",
      description:
        "Uma lista de transações feitas ou recebidas nas suas carteiras",
      conf: "conf"
    },
    details: {
      title: "Transação",
  ...
  send: {
    ...
    details: {
      ...
      amount_placeholder: "quantia a enviar (em BTCV)",
      fee_placeholder: "mais a taxa de transacção (em BTCV)",
      create_tx_error:
        "Erro na criação da transação, por favor confira se o endereço é válido.",
    ...
    create: {
      ...
      go_back: "Voltar",
      this_is_hex:
        "Este é o hex da transação, assinado e pronto para ser divulgado para o mundo. Continuar?",
      to: "Para",
      amount: "Valor",
      fee: "Taxa",
      tx_size: "Tamanho",
  ...
  buyBitcoin: {
    ...
    tap_your_address:
      "Toque seu endereço para copiá-lo para a área de transferência:",
    copied: "Copiado!"
  },
  settings: {
  ...
  plausibledeniability: {
    ...
    create_password_explanation:
      "A senha para a interface falsa não deve coincidir com a principal",
  ...
  lnd: {
    ...
    sameWalletAsInvoiceError:
      "Você não pode pagar uma fatura com a mesma carteira que a criou."
  },
  pleasebackup: {
