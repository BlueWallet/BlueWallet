module.exports = {
  ...
  wallets: {
    ...
    list: {
      ...
      title: 'wallets',
      header: 'En wallet er et sæt bestående af en hemmelig (privat nøgle) og en adresse' + 'du kan dele for at modtage coins.',
      add: 'Tilføj Wallet',
    ...
    add: {
      title: 'Tilføj wallet',
      description:
        'Du kan enten scanne en backup papir wallet (i WIF - Wallet Import Format), eller oprette en ny wallet. Segwit wallets er understøttet som standard.',
      scan: 'Scan',
      create: 'Opret',
  ...
  send: {
    ...
    details: {
      ...
      address_field_is_not_valid: 'Adresse felteter ikke gyldigt',
      ...
      fee_placeholder: 'plus transaktionsgebyr (in BTC)',
      note_placeholder: 'Notat til egent brug',
      cancel: 'Annuller',
      scan: 'Scan',
      send: 'Send',
      create: 'Opret',
    ...
    create: {
      ...
      go_back: 'Tilbage',
      this_is_hex: 'Dette er transaktion hex, klar til at sende til netværket.',
      to: 'Til',
      amount: 'Beløb',
      fee: 'Gebyr',
