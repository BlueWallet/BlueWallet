module.exports = {
  _: {
    storage_is_encrypted:
      "O armazenamento está encriptado. Uma password é necessária para desencriptar",
  ...
  transactions: {
    list: {
      ...
      title: "transacções",
      description:
        "Uma lista de transacções feitas ou recebidas nas suas wallets",
      conf: "conf"
    },
    details: {
      title: "detalhes",
  ...
  send: {
    ...
    details: {
      ...
      create_tx_error:
        "Houve um erro na criação da transacção. Por favor verifique que o endereço é válido.",
  ...
  plausibledeniability: {
    ...
    create_password_explanation:
      "Password para armazenamento FALSO não deve coincidir com a password principal",
  ...
  lnd: {
    ...
    sameWalletAsInvoiceError:
      "Não pode pagar uma factura com a mesma wallet usada para a criar."
  },
  pleasebackup: {
