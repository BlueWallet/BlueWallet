...
| Passphrase | Passphrase | noun · kept English per maintainer decision (PR #8738). ⚠️ NOT `palavra-passe` (= password) and NOT `senha`. Native alternates if ever needed: `frase-passe` (Electrum pt_PT), `frase de segurança` (Bitcoin Core pt). |
