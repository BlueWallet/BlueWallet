module.exports = {
 ...
 wallets: {
   ...
   list: {
     app_name: 'BlueWallet',
     title: 'beursies',
     header: 'U beursie verteenwoordig ‘n sleutelkombinasie, bestaande uit geheims (privaat sleutel) en address' + 'wat u kan gebruik om fondse te ontvang.',
     add: 'Skep Beursie',
 ...
 plausibledeniability: {
   ...
   help: 'Onder sekere omstandighede mag u dalk geforseer word om u ' +
