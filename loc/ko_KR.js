module.exports = {
  ...
  wallets: {
    ...
    add: {
      title: "지갑 추가하기",
      description: "백업 종이 지갑 스캔 ( WIF - Wallet Import Format) 또는 새로운 지갑을 생성할 수 있습니다. Segwit 지갑은 기본값으로 지원됩니다.",
      scan: "스캔하기",
      create: "생성하기",
    ...
    import: {
      title: "들여오기",
      explanation: "연상 기호문, 개인 키, WIF 등의 모든 것을 이곳에 입력해 주세요. 블루웰럿이 최적의 포맷과 지갑 들여오기를 도와드립니다.",
      imported: "들여오기 완료",
  ...
  plausibledeniability: {
    title: "입력 생략",
    help: "특정한 상황에 고객님께서 비밀번호를 공개에 대한 요구를 받을 수도 있습니다. 고객님의 코인을 안전히 보관하기 위하여, 블루웰렛은 다른 비밀번호에 연동된 또 다른 암호화 저장소를 생성할 수 있습니다. 제 3자에 해당 비밀번호가 노출될 수 있으며, 블루웰렛에 비밀번호 입력시 새로운 모조 저장소가 잠금 해제됩니다. 이것이 제 3자에겐 고객님의 저장소에 접근한 것처럼 보입니다. 그러나 고객님의 코인이 보관된 메인 저장소는 비밀리에 안전하게 보존됩니다.",
    help2: "새로운 저장소가 정상적으로 작동될 것입니다. 최소한의 금액을 보관하여 더욱 믿을 수 있는 저장소임을 확인하세요. ",
