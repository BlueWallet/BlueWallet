module.exports = {
  ...
  wallets: {
    ...
    list: {
      ...
      empty_txs1_lightning: "Ví Lightning nên được sử dụng cho giao dịch hàng ngày của quý khách. Phí rẻ và tốc độ nhanh",
    ...
    add: {
      title: "thêm ví",
      description: "Quý khách có thể quét mặt sau của ví( ở WIF - Định dạng nhập Ví) hoặc tạo ví mới, Segwwit được hỗ trợ mặc định",
      scan: "Quét",
      create: "Tạo'",
    ...
    import: {
      title: "nhập",
      explanation: "Viết ở đây bản ghi nhớ, khóa riêng, WIF hoặc bất cứ thứ gì quý khách có. GoldWallet sẽ cố hết sức để đoán đúng định dạng và nhập ví của quý khách",
      imported: "Đã nhập",
  ...
  plausibledeniability: {
    ...
    create_password_explanation: "Mật khẩu cho bộ nhớ giả không được khớp với mật khẩu cho bộ lưu trữ chính của quý khách",
    password_should_not_match: "Mật khẩu cho bộ nhớ giả không được khớp với mật khẩu cho bộ lưu trữ chính của quý khách",
    retype_password: "Nhập lại mật khẩu",
  ...
  pleasebackup: {
    ...
    text: "Vui lòng dành chút thời gian để viết cụm ghi nhớ này trên một tờ giấy. Nó sẽ là bản sao lưu của quý khách, quý khách có thể sử dụng nó để khôi phục ví ở trên thiết bị khác",
