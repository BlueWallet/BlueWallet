module.exports = {
  ...
  wallets: {
    ...
    list: {
      ...
      empty_txs1_lightning: "La cartera lightning se debe usar para sus transacciones diarias. Las tarifas son injustamente baratas y la velocidad es increíblemente rápida.",
    ...
    add: {
      ...
      description: "Puede escanear la cartera de papel de respaldo (en WIF, formato de importación de carteras) o crear una nueva cartera. Las carteras SegWit son compatibles por defecto.",
      scan: "Escanear",
      create: "Crear",
  ...
  plausibledeniability: {
    ...
    create_password_explanation: "La contraseña para el almacenamiento falso no puede ser la misma que para su almacen principal.",
    password_should_not_match: "La contraseña para el almacenamiento falso no puede ser la misma que para su almacen principal.",
  ...
  pleasebackup: {
    ...
    text: "Tómese un momento para escribir esta frase mnemónica en una hoja de papel. Es su copia de seguridad que puede usar para restaurar la cartera en otro dispositivo.",
