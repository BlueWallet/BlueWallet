module.exports = {
  _: {
    storage_is_encrypted:
      "Su almacenamiento está cifrado. Se requiere contraseña para descifrarlo.",
  ...
  wallets: {
    ...
    import: {
      ...
      imported: "Importado",
      error:
        "No se ha podido importar. Asegúrese de que los datos que ha proporcionado son válidos.",
      success: "Éxito",
      do_import: "Importar",
  ...
  transactions: {
    list: {
      ...
      title: "transacciones",
      description:
        "Una lista de las transacciones entrantes o salientes de sus carteras",
      conf: "conf"
    },
    details: {
      title: "Transaccion",
  ...
  send: {
    ...
    create: {
      ...
      error:
        "Error al crear la transacción. ¿La dirección o cantidad son invalidas?",
      go_back: "Regresar",
      this_is_hex:
        "Esta es una transacción hexadecimal, firmada y lista para ser transmitida a la red.",
      to: "A",
      amount: "Cantidad",
      fee: "Tasa",
  ...
  settings: {
    ...
    password: "Contraseña",
    password_explain:
      "Cree la contraseña que usará para descifrar el almacenamiento",
  ...
  lnd: {
    ...
    sameWalletAsInvoiceError:
      "No puede pagar una factura con la misma cartera utilizada para crearla."
  },
  pleasebackup: {
