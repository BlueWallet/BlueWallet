...
HodlHodl.navigationOptions = ({ navigation, route }) => ({
  ...
  headerLeft: () => {
    return route.params.displayLoginButton ? (
      <BlueButtonLink title="Login" onPress={route.params.handleLoginPress} style={{ marginHorizontal: 20 }} />
    ) : (
      <BlueButtonLink title="My contracts" onPress={route.params.handleMyContractsPress} style={{ marginHorizontal: 20 }} />
    );
  },
});
