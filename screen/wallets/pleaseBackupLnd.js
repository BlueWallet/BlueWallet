...
const PleaseBackupLnd = () => {
  ...
  useEffect(() => {
    (async () => {
      setLnddir(await wallet.getLndDir());
    })();
  ...
  return (
    <SafeBlueArea style={styles.root}>
      ...
      <ScrollView centerContent contentContainerStyle={styles.scrollViewContent}>
        <View>
          <BlueTextCentered>
            Please save this wallet backup. It allows you to restore ONCHAIN funds. To backup channels (i.e. offchain funds) following
            folder should be backed up manually: {lnddir}
          </BlueTextCentered>
          <BlueSpacing20 />
        </View>
        <BlueSpacing20 />
...
PleaseBackupLnd.navigationOptions = navigationStyle({
  closeButton: true,
...
export default PleaseBackupLnd;
