  ...
  renderSellFiat = () => {
    return (
      <TouchableOpacity
        ...
        style={styles.marketplaceButton2}
      >
        <Text style={styles.marketpalceText1}>{loc.wallets.listTap_here_to_buy}</Text>
      </TouchableOpacity>
    );
  };
            ...
            ListEmptyComponent={
              <ScrollView style={styles.flex} contentContainerStyle={styles.scrollViewContent}>
                <Text numberOfLines={0} style={styles.emptyTxs}>
                  {(this.isLightning() && loc.wallets.listEmpty_txs1_lightning) || loc.wallets.list.empty_txs1}
                </Text>
                {this.isLightning() && <Text style={styles.emptyTxsLightning}>{loc.wallets.listEmpty_txs2_lightning}</Text>}
                ...
                {!this.isLightning() && (
                  ...
                  >
                    <Text style={styles.buyBitcoinText}>{loc.wallets.listTap_here_to_buy}</Text>
                  </TouchableOpacity>
                )}
              </ScrollView>
            }
