...
export default class Confirm extends Component {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      feeSatoshi: new Bignumber(props.navigation.getParam("fee"))
        ...
        <View style={{ flexDirection: "row", justifyContent: "center" }}>
          ...
          >
            {item.amount === BitcoinUnit.MAX
              ? currency.satoshiToBTC(
                  this.state.fromWallet.getBalance() - this.state.feeSatoshi
                )
        ...
        >
          ...
          >
            <BlueCard>
              ...
              >
                {loc.send.create.fee}:{" "}
                {loc.formatBalance(this.state.feeSatoshi, BitcoinUnit.BTC)}
              </Text>
              <BlueSpacing40 />
