        ...
        <View>
          ...
          <Text style={styles.transactionDetailsSubtitle}>
            {item.amount === BitcoinUnit.MAX
              ? currency.satoshiToBTC(this.state.wallet.getBalance()) -
                this.state.fee
        ...
        <TouchableWithoutFeedback onPress={Keyboard.dismiss} accessible={false}>
          <ScrollView>
            <BlueCard style={{ alignItems: "center", flex: 1 }}>
              <BlueText style={{ color: "#0c2550", fontWeight: "500" }}>
              ...
              <TouchableOpacity
                ...
                onPress={() => Clipboard.setString(this.state.tx)}
              >
                <Text
                  style={{
                    color: "#9aa0aa",
              ...
              <TouchableOpacity
                style={{ marginVertical: 24 }}
                onPress={() =>
                  Linking.openURL("https://coinb.in/?verify=" + this.state.tx)
                }
              >
                <Text
                  style={{
            ...
            <BlueCard>
              ...
              <Text style={styles.transactionDetailsTitle}>
                {loc.send.create.tx_size}
              </Text>
              <Text style={styles.transactionDetailsSubtitle}>
                {this.state.size} bytes
              </Text>

              <Text style={styles.transactionDetailsTitle}>
                {loc.send.create.satoshi_per_byte}
              </Text>
              <Text style={styles.transactionDetailsSubtitle}>
                {this.state.satoshiPerByte} Sat/B
              </Text>
              {this.state.memo.length > 0 && (
                <>
                  <Text style={styles.transactionDetailsTitle}>
                    {loc.send.create.memo}
                  </Text>
                  <Text style={styles.transactionDetailsSubtitle}>
                    {this.state.memo}
                  </Text>
