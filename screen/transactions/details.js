  ...
  render() {
    ...
    return (
      <SafeBlueArea forceInset={{ horizontal: 'always' }} style={styles.root}>
        ...
        <BlueHeaderDefaultSub leftText={loc.transactions.detailsTitle} rightComponent={null} />
        <ScrollView style={styles.scroll}>
          <BlueCard>
            ...
            {'from' in this.state && (
              <>
                <View style={styles.rowHeader}>
                  <BlueText style={styles.rowCaption}>{loc.transactions.detailsFrom}</BlueText>
            ...
            {'to' in this.state && (
              <>
                <View style={styles.rowHeader}>
                  <BlueText style={styles.rowCaption}>{loc.transactions.detailsTo}</BlueText>
            ...
            {'hash' in this.state.tx && (
              <>
                ...
                >
                  <BlueText style={styles.txLink}>{loc.transactions.detailsShow_in_block_explorer}</BlueText>
                </TouchableOpacity>
              </>
            )}
