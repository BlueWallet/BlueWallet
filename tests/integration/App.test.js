...
it("SegwitP2SHWallet can generate segwit P2SH address from WIF", async () => {
  ...
  assert.ok(
    l.getAddress() === "34AgLJhwXrvmkZS1o5TrcdeevMt22Nar53",
    "expected " + l.getAddress()
  );
...
it("Wallet can fetch TXs", async () => {
  ...
  const txExpected = {
    block_hash:
      "0000000000000000000d05c54a592db8532f134e12b4c3ae0821ce582fad3566",
    block_height: 530933,
    block_index: 1587,
    ...
    inputs: [
      {
        prev_hash:
          "d0432027a86119c63a0be8fa453275c2333b59067f1e559389cd3e0e377c8b96",
        output_index: 1,
        script:
    ...
    outputs: [
      {
        ...
        spent_by:
          "009c6219deeac341833642193e4a3b72e511105a61b48e375c5025b1bcbd6fb5",
...
describe("currency", () => {
  it("fetches exchange rate and saves to AsyncStorage", async () => {
    ...
    await AsyncStorage.setItem(
      AppStorage.PREFERRED_CURRENCY,
      JSON.stringify(FiatUnit.JPY)
    );
    await currency.startUpdater();
