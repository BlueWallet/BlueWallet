...
describe('AbstractHDElectrumWallet.cosign', () => {
  itIfEnv(['HD_MNEMONIC_OLD', 'HD_MNEMONIC_BIP49'])(
    'different descendants of AbstractHDElectrumWallet can cosign one transaction',
    async () => {
      const w1 = new HDLegacyP2PKHWallet();
      w1.setSecret(requiredEnv('HD_MNEMONIC_OLD'));
      ...
      w2.setSecret(requiredEnv('HD_MNEMONIC_OLD'));
      ...
      w3.setSecret(requiredEnv('HD_MNEMONIC_BIP49'));
  ...
  itIfEnv('MNEMONICS_COBO')('HDSegwitBech32Wallet can cosign psbt with correct fingerprint', async () => {
    const w = new HDSegwitBech32Wallet();
    w.setSecret(requiredEnv('MNEMONICS_COBO'));
  ...
  itIfEnv('HD_MNEMONIC_BIP84')('can cosign with non-zero account', async () => {
    const signerWallet = new HDSegwitBech32Wallet();
    signerWallet.setSecret(requiredEnv('HD_MNEMONIC_BIP84'));
