    ...
    return (
      <SafeAreaView style={{ flex: 1 }}>
        ...
        >
          ...
          <View
            style={{ flex: 0.2, justifyContent: "flex-end", marginBottom: 58 }}
          >
            <View style={{ justifyContent: "center", flexDirection: "row" }}>
              {(this.state.biometricType === Biometric.TouchID ||
                this.state.biometricType === Biometric.Biometrics) &&
                !this.state.isStorageEncrypted && (
                  <>
                    <TouchableOpacity
                      disabled={this.state.isAuthenticating}
                      onPress={this.unlockWithBiometrics}
                    >
                      <Image
