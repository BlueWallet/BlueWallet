...
class WidgetAPI {
  static func fetchPrice(currency: String, completion: @escaping ((WidgetDataStore?, Error?) -> Void)) {
    ...
    default:
      urlString = "https://api.coinpaprika.com/v1/coins/doi-doicoin/ohlcv/latest"
    }
    //
    //"https://api.coinpaprika.com/v1/coins/doi-doicoin/ohlcv/historical?start=2021-03-18&quote=usd"
