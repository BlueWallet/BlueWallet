...
last 4 digits of the build and announce it - this is now an RC. no need to fill release notes yet 
...
in `Release notes` write the release, this field is to smaller than iOS, so you need to keep it below 500 characters.
