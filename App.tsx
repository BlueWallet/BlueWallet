...
import { linking, syncBitcoinDeepLinkDispatchFromNavigation } from './navigation/linking';
  ...
  return (
    <SizeClassProvider>
      <NavigationContainer
        ...
        onReady={syncBitcoinDeepLinkDispatchFromNavigation}
        onStateChange={syncBitcoinDeepLinkDispatchFromNavigation}
      >
        <SafeAreaProvider>
          <StorageProvider>
            <SettingsProvider>
